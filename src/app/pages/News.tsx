              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {newsList.map((article, idx) => (
                  <motion.div 
                    ...
                    className="group p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-all duration-300 cursor-pointer flex flex-col"
                    onClick={() => setSelectedId(article.id)}
                  >
                    <div className="flex flex-wrap gap-4 items-center mb-6 text-sm font-mono">
                    ...
                    <div className="flex items-center text-blue-400 font-medium text-sm gap-2 mt-auto">
